...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'password':'n7kYKX4zkeJK2RG',
        'email':'Mable_Koepp@yahoo.com',
        'name':'Carlton Smitham',
        'userType':authConstant.USER_TYPES.Admin,
        'phone_number':'deposit',
        'profile_img':'Nauru',
        'sign_img':'Intelligent',
        'address_line_1':'Plastic',
        'address_line_2':'parse',
        'crater_name':'HTTP',
        'colony_name':'SCSI',
        'pincode':'Ecuador',
        'age':31,
        'profession':'Cheese',
        'experience':'copy',
        'dob':'2023-10-18T07:45:21.477Z',
        'hobbies':'hierarchy',
        'SDGs':'Granite',
        'investment_frequency':'pixel',
        'company_domains':'XSS',
        'impact_domains':'cyan',
        'notif_token':'Bedfordshire',
        'isAuth':true,
        'blob':'CSS',
        'mobileNo':'(874) 250-8956'
      });
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Mable_Koepp@yahoo.com', });
...
describe('POST /validate-otp -> otp is sent in request body and OTP is correct', () => {
  test('should return success', () => {
    return request(app)
      ...
      .send(
        {
          username: 'Mable_Koepp@yahoo.com',
          password: 'n7kYKX4zkeJK2RG'
        }).then(login => () => {
        return request(app)
